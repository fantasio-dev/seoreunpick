...
function seedIfEmpty(handle: Database.Database): void {
  ...
  // 알고리즘이 한눈에 보이도록 샘플 응답 주입.
  //  07-08 → 🟢 확정추천 (앵커 둘 다 O, 7명)
  //  07-07 → 🟡 조건부 (정족수는 OK지만 앵커 이승현 X)
  //  07-09 → 🟡 조건부 (앵커 OK지만 정족수 -1, 미응답 전원 O면 도달 가능)
  //  07-10 → ⚪ 탈락
  //  라윤철, 김선우 → 전혀 응답 안 함(미응답)
  const v: Record<string, Record<string, 'O' | '△' | 'X'>> = {
    최태석: { '2026-07-07': 'O', '2026-07-08': 'O', '2026-07-09': '△', '2026-07-10': 'X' },
    김정욱: { '2026-07-07': 'O', '2026-07-08': 'O', '2026-07-09': 'O', '2026-07-10': '△' },
    이승현: { '2026-07-07': 'X', '2026-07-08': 'O', '2026-07-09': 'O', '2026-07-10': 'X' },
    이풍환: { '2026-07-07': 'O', '2026-07-08': 'O', '2026-07-09': '△', '2026-07-10': 'O' },
    류재우: { '2026-07-07': 'O', '2026-07-08': 'O', '2026-07-09': 'X', '2026-07-10': '△' },
    윤희욱: { '2026-07-07': 'O', '2026-07-08': 'O', '2026-07-09': 'O', '2026-07-10': 'X' },
    김민석: { '2026-07-07': '△', '2026-07-08': 'O', '2026-07-09': 'O', '2026-07-10': 'O' },
  }
